...
!
! Originally from: f/common/dirac.f
!
c       =================================================
...
c       - - - - - - - - - - - - - - - - - - - - - - - - -
     ...
     &  vloc(maxii),vsemi_loc(maxii,6),wsemi_loc(maxii,6),ww(maxii)
        ...
        real*8 a(maxii),b(maxii),c(maxii)
...
320     if (niter.gt.1) then
          if (knucl.ne.1.or.inucl.le.1) then
            call SHAB_correct(1,ii-2,tn,p,q,cp,cq)
          else
            call SHAB_correct(1,inucl,tn,p,q,cp,cq)
            call SHAB_correct(inucl,ii-2,tn,p,q,cp,cq)
          endif
        endif
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        n1=0
...
c       =================================================
        subroutine SHAB_correct(imin,imax,tn,p,q,cp,cq)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        implicit real*8 (a-h,o-z)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        include 'qedmod.inc'
...
c       =================================================
        subroutine SHAB_origin(kappa,p,q)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        implicit real*8 (a-h,o-z)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        include 'qedmod.inc'
