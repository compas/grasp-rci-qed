...
!
! Originally from: f/potgen/uehling.f
!
c       =================================================
...
c       from the paper:
c       L.W.Fullerton and G.A. Rinker, PRA 13, 1283 (1976)
...
c       =================================================
        real*8 function SHAB_dk0(x)
        implicit real*8(a-h,o-z)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
c       Fullerton'a and Rinker'a, PRA 13, 1283 (1976)
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        SHAB_dk0=0.d0
c       - - - - - - - - - - - - - - - - - - - - - - - - -
        a0= 0.88357293375d0
...
c       - - - - - - - - - - - - - - - - - - - - - - - - -
     ...
     #        +a6*x**6+a7*x**7
          ...
          if (x.gt.0) then
            SHAB_dk0=dp7+x*dp21*dlog(x)
          else
            SHAB_dk0=dp7
          endif
        else
          SHAB_dk0=dexp(-x)*(d0+d1/x+d2/x**2+d3/x**3+d4/x**4)
...
c       - - - - - - - - - - - - - - - - - - - - - - - - -
     ...
     #        +a6*x**6+a7*x**7
          ...
          SHAB_dk1=dp7+dp21*dlog(x)
        else
          SHAB_dk1=dexp(-x)*(d0+d1/x+d2/x**2+d3/x**3+d4/x**4)
